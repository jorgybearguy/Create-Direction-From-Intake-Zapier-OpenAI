...
**Strict prompt template:** [/prompt/system_prompt.template.txt] (https://github.com/jorgybearguy/Create-Direction-From-Intake-Zapier-OpenAI/tree/main/prompt#:~:text=system_prompt.template.txt) 
